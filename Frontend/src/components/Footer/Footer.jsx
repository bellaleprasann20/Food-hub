                        ...
                        <form onSubmit={handleSubmit} className="relative mt-4 group">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    // FIXED: Changed focus-outline-none to focus:outline-none
                                    className="w-full px-4 py-2.5 rounded-lg bg-amber-50/5 border-2 border-amber-400/30 focus:outline-none focus:border-amber-400 focus:ring-amber-400/20 transition-all duration-300 placeholder-amber-200/50 pr-24"
                                    required
                                />
                            ...
                            <div className="flex space-x-4">
                                {socialIcons.map(({ icon: Icon, link, color, label }, idx) => (
                                    <a 
                                        ...
                                        style={{ color }} // FIXED: Moved style inside the <a> tag correctly
                                    >
