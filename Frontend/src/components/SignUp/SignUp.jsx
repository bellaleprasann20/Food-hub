      ...
      <div className="w-full max-w-md bg-gradient-to-br from-[#2d1b0e] to-[#4a372a] p-8 rounded-xl shadow-lg border-4 border-amber-700/30 transform transition-all duration-300 hover:shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative">
            ...
            <button className="absolute inset-y-0 right-0 pr-3 flex items-center text-amber-400 hover:text-amber-600 transition-all transform hover:scale-125" type="button" onClick={toggleShowPassword}>
