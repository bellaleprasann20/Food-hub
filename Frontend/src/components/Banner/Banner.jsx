...
const Banner = () => {
    ...
    // Ensure 'video' is extracted from your assets
                ...
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10">
                    ...
                    <div className="flex-1 space-y-8 relative md:pr-8 lg:pr-19 text-center md:text-left">
                        <h1 className="text-4xl sm:text-5xl md:text-4xl lg:text-6xl font-bold leading-tight font-serif drop-shadow-md">
                            We're Here <br />
                            <span className="text-amber-400 bg-gradient-to-r from-amber-400 to-amber-300 bg-clip-text"> For Food & Delivery</span>
                        </h1>
                        <p className="text-lg md:text-lg lg:text-xl font-playfair italic sm:text-xl text-amber-100 max-w-xl opacity-90 mx-auto md:mx-0">
                            Best cooks and best delivery guys all at your service. Hot tasty food will reach you in 20 minutes.
                        </p>
                        ...
                        <form onSubmit={handleSearch} className='relative max-w-2xl mx-auto md:mx-0 group'>
                            <div className="relative flex items-center bg-amber-900/30 rounded-xl border-2 border-amber-500/30 shadow-2xl hover:bg-amber-400/50 transition-all duration-300">
                                ...
                                <input 
                                    ...
                                    className="w-full py-4 pr-6 bg-transparent outline-none placeholder-amber-200/70 text-lg font font-medium tracking-wide" 
                                />
                    ...
                    <div className="flex-1 relative group mt-12 md:mt-0 min-h-[400px] flex items-center justify-center">
                        
                        {/* 1. ORBITAL IMAGES (Rendered FIRST to stay behind) */}
                        {orbitImages.map((imgSrc, index) => (
                            <div key={index} className={`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-0
                                ${index === 0 ? 'orbit' : `orbit-delay-${index * 5}`} 
                                w-[80px] xs:w-[100px] sm:w-[130px] h-[80px] xs:h-[100px] sm:h-[130px]`}>
                        ...
                        {/* 2. MAIN BANNER IMAGE (z-10 and rendered AFTER orbital images) */}
                        <div className="relative rounded-full p-1 bg-gradient-to-br from-amber-700 via-amber-800 to-amber-400 shadow-2xl z-10 w-[250px] xs:w-[300px] sm:w-[350px] h-[250px] xs:h-[300px] sm:h-[350px]">
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-md p-4 transition-all">
                    <div className="relative w-full max-w-4xl aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl border border-amber-500/20">
                        ...
                        <button 
                            ...
                            className="absolute top-4 right-4 z-[110] bg-amber-500 hover:bg-amber-400 text-amber-900 w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 shadow-lg font-bold text-xl"
                        >
                            ✕
                        </button>
