...
export const socialIcons = [
    ...
    { icon: FaInstagram, link: 'https://www.instagram.com/prasannbellale?igsh=MWQ3bmVndDgxMnFlaQ==', color: '#E1306C', label: 'Instagram' },
    { icon: FaXTwitter, link: 'https://x.com/BellalePrasann', color: '#000', label: 'X' },
    { icon: FaYoutube, link: 'https://www.youtube.com/@Victortech00', color: '#FF0000', label: 'Youtube' },
];
